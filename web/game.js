(() => {
  ...
  const menuTitle = document.querySelector('#menu-title'), menuCopy = document.querySelector('#menu-copy'), dismissResult = document.querySelector('#result-dismiss'), nextButton = document.querySelector('#new-game'), soundButton = document.querySelector('#sound-toggle'), profileButton = document.querySelector('#profile-toggle'), usernameInput = document.querySelector('#username'), leaderboard = document.querySelector('#leaderboard'), leaderboardBody = document.querySelector('#leaderboard-body'), assets = {};
