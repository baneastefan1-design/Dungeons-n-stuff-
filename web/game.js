(() => {
  ...
  function draw() {
    ...
    ctx.fillStyle='#f6f4e8'; ctx.font=`700 ${Math.max(14,tile*.31)}px system-ui`; ctx.textAlign='left'; ctx.fillText(`Moves ${state.moves}   ${state.hard_mode ? 'Hard' : 'Normal'}${state.has_treasure ? '   Treasure ✓' : ''}`,left,top-14);
